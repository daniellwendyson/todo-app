...
function render () {
    ...
    if(unCompletedTodos.length > 0) {
        ...
        uncompletedTodosDiv.innerHTML = `<div class='empty'>Nenhuma missão incompleta</div>`;
    }

    if(completedTodos.length > 0) {
        completedTodosDiv.innerHTML = `<div class='completed-title'>Completado (${completedTodos.length} / ${todoItems.length})</div>`;
...
function createTodoElement(todo) {
    ...
    todoTextSpan.innerText = todo.text;
